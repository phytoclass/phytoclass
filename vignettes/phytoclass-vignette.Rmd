...
For the examples that follow the argument *niter* equals five for processing speed, but should be set higher to obtain convergence. 
...
Results <- simulated_annealing(Clust1, niter = 5)
```
