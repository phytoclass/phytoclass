...
#' @param preserve_F Initial nnls C matrix from from non-binary F matrix values
#'           clamped to user_defined_min_max instead of starting with binary 0/1
#'           (default = TRUE)
...
simulated_annealing_Prochloro <- function(
  ...
  # ---- Static bounds for the CORE (exclude dvChl & Chl)
